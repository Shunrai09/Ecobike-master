...
<body>
    ...
    ?>
        ...
        <section class="container" style="padding-top: 20px;">
            <div class="textocard">
                <h1 style="margin-bottom: 80px;">REPUESTOS</h1>
            </div>
            <div class="row">
                <div class="col-md-4 card1">
                    <div class="card" style="width: 21rem;">
                        <img src="img/Accesorio 3.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Guantes amarillos</h5>
                ...
                <div class="col-md-4 card1">
                    <div class="card" style="width: 21rem;">
                        <img src="img/Accesorio4.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Casco E-Bike</h5>
                            <a href="#" class="btn btncard">Agregar al carrito<i class="bi bi-cart"></i></a>
                            <p>
                ...
                <div class="col-md-4 card1">
                    <div class="card" style="width: 21rem;">
                        <img src="img/Acessorio5.png" class="card-img-top"  alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Cadena de bicicletas</h5>
                            <a href="#" class="btn btncard">Agregar al carrito<i class="bi bi-cart"></i></a>
                            <p>
            ...
            <div class="row">
                <div class="col-md-4 card1">
                    <div class="card" style="width: 21rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Polo E-Bike 2</h5>
                            <a href="#" class="btn btncard">Agregar al carrito<i class="bi bi-cart"></i></a>
                            <p>
