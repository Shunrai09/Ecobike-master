        ...
        <section class="container">
            ...
            <section>
                <div class="row" style="margin-top: 70px;">
                    ...
                    <div class="col-md-6"  style="margin-right: 65px;">
                        <a href="Bicicletas.php" ><img style="justify-content: center; align-items: center;" height="700" src="img/tienda1.png" alt=""></a>
                    </div>
                    <div class="col-md-3">
                        <a href="Repuestos.php"><img src="img/tienda2.png" alt="" height="349"></a>
                        <a href="Monopatines.php"><img src="img/tienda3.png" alt="" height="349" style="margin-top: 2px;"></a>
                    </div>
                </div>
            </section>
        </section>
